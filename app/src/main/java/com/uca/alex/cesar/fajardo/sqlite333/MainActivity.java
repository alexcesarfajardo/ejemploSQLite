package com.uca.alex.cesar.fajardo.sqlite333;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et2 = findViewById(R.id.et_nombreyapellido);
        et3 = findViewById(R.id.et_colegio);
        et4 = findViewById(R.id.et_mesa);
    ...
    public void onReset(View view){
        ...
        Toast.makeText(this, "Los campos están limpios",
                Toast.LENGTH_SHORT).show();
    }
